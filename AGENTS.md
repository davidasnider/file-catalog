...
# Invalidate failed tasks for re-processing
...
- **Email Parser**: The `EmailParserPlugin` extracts email attachments to a dedicated `[file]_attachments/` directory located alongside the source email file.
