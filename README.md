...
- **Multimodal Vision Analysis**: A dedicated `VisionAnalyzerPlugin` unconditionally utilizes a multimodal Vision LLM to describe image content and categorize it as SFW/NSFW.
