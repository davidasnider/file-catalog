...
- **Streamlit Dashboard**: A beautiful dashboard at `localhost:8501` featuring:
  - **Accessible Metrics & UI**: Summary metrics, interactive filters, and dataframe columns feature descriptive tooltips (via `help`) for clear context. Empty states throughout the application provide actionable guidance.
