...
- **Implementation:** A suite of scripts in `src/scripts/` handles:
  ...
  4. **Diagnostic Tools:** Performance benchmarking, evaluation of AI-generated summaries, pipeline failure reporting, task invalidation, text extraction failure scanning, and file inspection (`perf_test_llms.py`, `evaluate_summaries.py`, `report_failures.py`, `invalidate_failed_tasks.py`, `scan_text_failures.py`, `inspect_file.py`).
