...
- **Schema Design:**
  - `Document`: Tracks path, robustly detected MIME type, file hash (to prevent duplicate processing if moved), and overall status (`PENDING`, `EXTRACTING`, `ANALYZING`, `COMPLETED`, `FAILED`).
